...
fileName = 'p=0.000 a=2.000 mu=-2.200 N=20000000 time=2017-02-22 01:09:51'
...
plt.ylabel(config[4] + ' ' + config[5])

plt.title(r'$p = {0}, \, \alpha = {1}, \, \mu = {2}, \, N = {3}$'.format(config[0], config[1], config[2], config[3]))
plt.legend(loc=1)
