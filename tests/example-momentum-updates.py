...
def DMC(t, N, sofisticated = True):
  ...
  feynmanDiagram = FeynmanDiagram(t, np.array([2, 0, 0]))
  ...
  if sofisticated:
    ...
    # updates = [shiftVertexPosition, swapPhononEnds, changePhononMomentum, changePhononMomentumDirection]
  else:
...
for i in range(0, n):
  ...
  b1122.append(bins[1122])
  b1212.append(bins[1212])
  b1221.append(bins[1221])
